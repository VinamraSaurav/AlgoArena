  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-10 md:px-[100px] lg:px-[200px] sm:px-[100px] px-[20px]">
        <Link href="/domains/2"><DomainCard className="cursor-pointer" title="WEB DEVELOPMENT" img={webd}/></Link>
        <Link href="/domains/1"><DomainCard className="cursor-pointer" title="DEVOPS" img={devops}/></Link>
        <Link href="/domains/3"><DomainCard className="cursor-pointer" title="BLOCKCHAIN" img={block}/></Link>
        <Link href="/domains/4"><DomainCard className="cursor-pointer" title="ARTIFICIAL INTELLIGENCE" img={ai}/></Link>
        <Link href="/domains/5"><DomainCard className="cursor-pointer" title="UI/UX" img={ui}/></Link>
        <Link href="/domains/0"><DomainCard className="cursor-pointer" title="APP DEVELOPMENT" img={appd}/></Link>
    </div>
    </
