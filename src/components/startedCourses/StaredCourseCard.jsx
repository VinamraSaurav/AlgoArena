  ...
  return (
    <div className="border rounded-xl border-color-2 p-4 mb-5 backdrop-blur-[5px] hover:shadow-[0_0_10px_3px_#4a0f87] cursor-pointer text-[white] hover:text-color-2">
      <div className=" flex gap-2">
        ...
        <div className="font-poppins text-2xl mb-4 md:mb-2 font-[900] bg-clip-text bg-gradient-course text-transparent w-auto line-clamp-1">
            {title}
          </div>
          <div className="text-md text-[white] font-popins font-[500] line-clamp-2 h-12">
            {description}
          </div>
          <div className="text-sm text-[white] font-popins font-[300] my-4">
            {videos} Videos
          </div>
          {progress == 0 ? (
            <div></div>
